...
from .models import Category, Product, Gallery, Review, FavoriteProducts, Mail, Customer, Order, OrderProduct, ShippingAddress, City
from django.utils.safestring import mark_safe


class GalleryInline(admin.TabularInline):
    fk_name = 'product'  # fk - foreign key
    model = Gallery
    extra = 1  # 1 minimum
...
class CategoryAdmin(admin.ModelAdmin):
    ...
    get_products_count.short_description = 'Number of goods'
